...
export type Validation<T> = {
  [Property in keyof T]?: IndicationMessage;
};

export abstract class IndicationMessage {

  public static isValid<T>(validation: Validation<T>) {
    for (const key of Object.keys(validation)) {
      const validationElement = validation[key] as IndicationMessage;
      if (validationElement && !validationElement.isValid()) {
        return false;
      }
    }
    return true;
