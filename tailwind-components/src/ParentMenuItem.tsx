...
export function ParentMenuItem({
  ...
  return (
    ...
    >
      ...
      <div
        className={`z-20 absolute transform mt-3 px-2 w-screen max-w-md sm:px-0 transition-opacity duration-300 ${
      ...
      >
        <div className="rounded-lg shadow-lg ring-1 ring-gray-50 ring-opacity-5 overflow-hidden">
          <div className="px-5 py-5 bg-white sm:px-8 sm:py-8">{children}</div>
        </div>
      </div>
    </div>
  );
